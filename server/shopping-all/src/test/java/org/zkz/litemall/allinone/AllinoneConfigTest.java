package org.zkz.litemall.allinone;
...
//        System.out.println(environment.getProperty(""));
        ...
        System.out.println(environment.getProperty("logging.level.org.zkz.litemall.wx"));
        System.out.println(environment.getProperty("logging.level.org.zkz.litemall.admin"));
        System.out.println(environment.getProperty("logging.level.org.zkz.litemall"));
    }
