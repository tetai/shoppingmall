package org.zkz.litemall.core.system;

import org.zkz.litemall.core.util.SystemInfoPrinter;
import org.zkz.litemall.db.service.LitemallSystemConfigService;
...
class SystemInistService {
    ...
    private Map<String, String> getSystemInfo() {
        ...
        infos.put("调试级别", environment.getProperty("logging.level.org.zkz.litemall.wx"));
